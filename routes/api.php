...
use App\Http\Controllers\employee\EmployeeProfileController as EmployeeProfileController;
...
Route::middleware('auth:sanctum','role:employee')->group(function () {
    ...
    Route::get("/employee/profile", [EmployeeProfileController::class, 'profile']);
    Route::patch('/change-password', [EmployeeProfileController::class, 'changePassword']);
    // Route::patch('/user/change-password', [UserController::class, 'changePassword']);
